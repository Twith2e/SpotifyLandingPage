    ...
    <nav className="d-flex justify-content-between align-items-center px-3">
      <div>
        ...
        <div className="d-flex flex-column">
          <span className="fz-14 text-white">Hello</span>
          <span className="fz-12">Adele</span>
        </div>
      </div>
      <div className="d-flex flex-column">
        <div className="d-flex justify-content-between">
          ...
          <button className="btn bg-grey1 d-flex align-items-center justify-content-center rounded-circle">
            <svg
              data-encore-id="icon"
              role="img"
              aria-hidden="true"
