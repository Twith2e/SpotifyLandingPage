...
export default function NavBar() {
  return (
    <nav className="d-flex justify-content-between align-items-center py-2 px-4">
      ...
      <div className="d-flex align-items-center gap-2 mid-nav">
        <button className="btn homebtn align-items-center bg-dark d-flex justify-content-center">
          <svg
            data-encore-id="icon"
            role="img"
            aria-hidden="true"
        ...
        <div className="d-flex align-items-center border-0 bg-dark rounded-pill searchbar px-3 justify-content-between w-100">
          <div className="w-100 d-flex align-items-center">
            ...
            <input
              className="border-0 bg-transparent w-100 search-input text-white"
      ...
      <div className="d-flex gap-3">
        <button className="btn border-0 text-secondary fw-bold">Sign up</button>
        <button className="btn border-0 bg-white rounded-pill fw-bold py-2 px-4">
          Log in
        </button>
      </div>
    </nav>
